        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">PRODUCTOS-AGREGAR</h1>
    ...
    <g:uploadForm action="guardar">
        ...
        <fieldset class="form">
           <label>Producto:</label>
                <g:field name ="miprod" type="text" pattern="[a-zA-Z0-9- ]+"  required=""/><br>
            <br>
           <label>Existencia:</label>
                <g:field name ="miexis" type="number" min="0" max="100"/><br><br>
            
            <label>Precio $</label>
                <g:field name="mipre" pattern="[0-9(.)0-9]+"/><br><br>

           <label>Categoria :</label>
                    <g:select optionKey="id"  optionValue="nombreCate" name="cat" from="${cate}" value="id"/><br><br>

           <label>Marca :</label>
                    <g:select optionKey="id"  optionValue="nombreMarca" name="marcas" from="${marc}" value="id"/><br><br>
        ...
        <fieldset class="buttons">
            ...
            <g:submitButton name="create" class="save" value="Guardar"/></center>
        </fieldset>
