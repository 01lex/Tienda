...
<body id="selection">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">PRODUCTOS-DETALLES</h1>
	...
	<br><h1>Detalles de</h1>
    <g:each var="o" in="${det}">
    <h4>Producto:${o[0].nombreProducto}</h4>
    <ul>
        <li>Precio:${o[0].precio}</li>
        <li>Existencia:${o[0].existencia}</li>
        <li>Categoria:${o[1].nombreCate}</li>
        <li>Marca:${o[2].nombreMarca}</li>
        <li>Fecha:${o[0].fechasol}</li>
