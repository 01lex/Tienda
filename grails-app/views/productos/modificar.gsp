...
<body id="selection">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">PRODUCTOS-MODIFICAR</h1>
	...
	<ul>
    <!--<li><g:link class="list" action="#"><g:message code="Atras" args="[entityName]" /></g:link></li></ul>-->
    <g:form action="modificar">
            
        <fieldset class="form">
            <g:hiddenField name="id" type="number" value="${mod.id}"/><br><br>
           <label>Producto:</label>
                <g:field name ="miprod" type="text" pattern="[a-zA-Z0-9- ]+" value="${mod.nombreProducto}"/><br><br>
            <label>Existencia:</label>
                <g:field name ="miexis" type="number" min="0" max="100"  value="${mod.existencia}"/><br><br>
            <label>Precio $</label>
                <g:field name="mipre" pattern="[0-9(.)0-9]+"  value="${mod.precio}"/><br><br>
           <label>Categoria :</label>
                    <g:select optionKey="id"  optionValue="nombreCate" name="micat" from="${categ}" value="${mod.cat.id}"/><br><br>
            <label>Marca :</label>
                    <g:select optionKey="id"  optionValue="nombreMarca" name="mimarca" from="${marc}" value="${mod.marcas.id}"/><br><br>
                       
        </fieldset>
        <fieldset class="buttons">
        
            <g:submitButton name="create" class="save" value="Modificar"/></center>
        </fieldset>
        </g:form>
