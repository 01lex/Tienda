...
<body id="selection">
	...
	<table class="table table-striped table-bordered table-hover" id="dataTables-example">
        ...
        <tr>
            ...
            <td><g:link action="eliminar" id="${o.id}" onclick="return confirm('¿Está seguro? Se eliminaran todos los produtos referentes a  ${o.nombreCate}')">Eliminar</g:link></td>
