        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">CATEGORIA-MODIFICAR</h1>
    ...
    <g:form action="modificar">
        <fieldset class="form">
            ...
            <label>Categoria</label>
                <g:field name ="micate" type="text" pattern="[a-zA-Z-0-9- ]+"   value="${mod.nombreCate}"/><br><br>
           <label>Descripcion:</label>
                <g:field name ="mides" type="text" pattern="[a-zA-Z-0-9- ]+"  value="${mod.descripcion}"/><br><br>      
        </fieldset>
